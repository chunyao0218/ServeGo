#pragma checksum "C:\Users\yao\Downloads\TFM103-No.2_Project - 複製\TwenGo\TwenGo\Views\Product\ProductView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5b4ab20c634d34393db92b6c803eadbc7668a769"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5b4ab20c634d34393db92b6c803eadbc7668a769", @"/Views/Product/ProductView.cshtml")]
    ...
    public class Views_Product_ProductView : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<TwenGo.Models.Product>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5b4ab20c634d34393db92b6c803eadbc7668a7695880", async() => {
            }
            );
...
<div id=""app"">
    <div class=""row"">
     ...
     ");
            WriteLiteral(@"               <p style=""height:10px""></p>
    ...
    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5b4ab20c634d34393db92b6c803eadbc7668a7698326", async() => {
                WriteLiteral(@"
                    ...
                    .then(response =>
                        response.json()
                            .then(d => {
                                ...
                                self.put = d;
                                $");
            WriteLiteral(@"('#twzipcode').twzipcode('set', {
                                    'county': county,
                                    'district': district,
                                });
                                $('#myModal').modal(""show"");
...
");
            WriteLiteral(@"                var q = confirm(""確定要更新服務資料?"")
                if (q) {
                    fetch(""/products/""+id, {
                        method: 'PUT',
                        body: data
...
");
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<TwenGo.Models.Product> Html { get; private set; }
    }
}
